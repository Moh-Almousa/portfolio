...
> أي رابط تتركه `''` أو `YOUR_...` يظهر **معطّلًا** في الموقع بدل رابط وهمي.
...
> قبل التفعيل: النموذج **لا يدّعي** أن الرسالة أُرسلت، بل يعرض رسالة واضحة
> ويفتح برنامج البريد لديك والرسالة جاهزة.
...
## 10. قائمة ما يجب إكماله قبل النشر

- [ ] استبدال `assets/images/profile.jpg` بصورتك
- [ ] استبدال `assets/images/projects/coachlink/icon.png` بأيقونة المشروع
- [ ] حذف الصور التجريبية `1.jpg` … `7.jpg` ووضع صور المشروع الحقيقية
- [ ] تحديث مصفوفة `images` في `js/data/projects.js`
- [ ] وضع محتوى README الحقيقي في `projects/coachlink/README.md`
- [ ] وضع رابط Documentation مكان `YOUR_DOCUMENTATION_URL`
- [ ] وضع روابط GitHub و LinkedIn و Facebook في `js/data/contact.js`
- [ ] تفعيل Web3Forms (القسم 8)
- [ ] وضع رابط الموقع مكان `YOUR_SITE_URL` في `index.html`
